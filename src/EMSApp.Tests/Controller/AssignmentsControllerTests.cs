...
public class AssignmentsControllerTests
{
    ...
    {
        // Arrange
        var req = new CreateAssignmentRequest { Title = "T", Description = "D", DueDate =  DateTime.Parse("2025-05-20"), AssignedToId = "u1" };
        var a = new Assignment("T", "D", req.DueDate, req.AssignedToId);
        ...
        _svc.Setup(s => s.CreateAsync(req.Title, req.Description, req.DueDate, req.AssignedToId, _ct))
            .ReturnsAsync(a);
        ...
        _svc.Verify(s => s.CreateAsync(req.Title, req.Description, req.DueDate, req.AssignedToId, _ct), Times.Once);
    }
    ...
    public async Task ListByAssignee_CallsService()
    {
        ...
        // Act
        var result = await _ctrl.ListByAssignee("u3", null, null, _ct);
