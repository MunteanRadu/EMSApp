...
public class Schedule
{
    ...
    private readonly HashSet<DateOnly> _exceptions = new();
    public IReadOnlyCollection<DateOnly> Exceptions => _exceptions;
    ...
    public IEnumerable<DateOnly> NextOccurrences(DateOnly after, int count)
    {
        ...
        while (found < count)
        {
            if (IsWorkingDay && !_exceptions.Contains(current))
            {
